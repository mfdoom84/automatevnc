...
class ExecutionContext:
    ...
    def __init__(
        ...
        # Set logger on vnc client as well
        if self.logger and not self.vnc.logger:
            self.vnc.logger = self.logger
    ...
    def wait(self, seconds: float) -> "ExecutionContext":
        """Proxy to vnc.wait."""
        self.vnc.wait(seconds)
        return self

    def click(self, *args, **kwargs) -> Any:
        """Proxy to vnc.click."""
        return self.vnc.click(*args, **kwargs)

    def double_click(self, *args, **kwargs) -> Any:
        """Proxy to vnc.double_click."""
        return self.vnc.double_click(*args, **kwargs)

    def right_click(self, *args, **kwargs) -> Any:
        """Proxy to vnc.right_click."""
        return self.vnc.right_click(*args, **kwargs)

    def type(self, *args, **kwargs) -> "ExecutionContext":
        """Proxy to vnc.type."""
        self.vnc.type(*args, **kwargs)
        return self

    def press(self, *args, **kwargs) -> "ExecutionContext":
        """Proxy to vnc.press."""
        self.vnc.press(*args, **kwargs)
        return self

    def key_combo(self, *args, **kwargs) -> "ExecutionContext":
        """Proxy to vnc.key_combo."""
        self.vnc.key_combo(*args, **kwargs)
        return self
        
    def wait_for_image(self, *args, **kwargs) -> bool:
        """Proxy to vnc.wait_for_image."""
        return self.vnc.wait_for_image(*args, **kwargs)

    def find_template(self, *args, **kwargs) -> Any:
        """Proxy to vnc.find_template."""
        return self.vnc.find_template(*args, **kwargs)
    ...
    def run_script(self, name: str, **kwargs) -> Any:
        ...
        # Temporarily switch templates_dir to this script's folder
        old_templates_dir = self.vnc.templates_dir
        self.vnc.templates_dir = os.path.join(self.templates_dir, name)
        ...
        try:
            ...
            self.vnc.templates_dir = old_templates_dir
